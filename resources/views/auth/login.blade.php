    ...
    <div class="container" role="main" aria-label="Login">
        ...
        <form action="{{ route('login') }}" method="POST" autocomplete="off" novalidate>
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" name="email" placeholder="Masukkan Email" required autocomplete="username" aria-describedby="emailHelp" aria-label="Email" />
            </div>

            <label for="password">Kata Sandi</label>
            <div class="input-group">
                <i class="fa-solid fa-lock" aria-hidden="true"></i>
                <input type="password" id="password" name="password" placeholder="Masukkan Kata Sandi" required autocomplete="current-password" aria-label="Kata Sandi" />
            </div>
