        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-tentang-kami" role="tabpanel" aria-labelledby="v-tentang-kami-tab">
                       <form action="{{ route('admin.setting.tentang-kami') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <textarea id="tentang_kami" name="tentang_kami" class="form-control">{{$settings['tentang_kami'] ?? null}}</textarea>
                    ...
                    <form action="{{ route('admin.setting.syarat-ketentuan') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <textarea id="syarat_ketentuan" name="syarat_ketentuan" class="form-control">{{$settings['syarat_ketentuan'] ?? null}}</textarea>
                            <div class="d-flex justify-content-end mt-2">
                                <button type="submit" class="btn btn-dark">Save</button>
                            </div>
                    </form>
                    ...
                    <div class="tab-pane fade" id="v-layanan" role="tabpanel" aria-labelledby="v-layanan-tab">
                       <form action="{{ route('admin.setting.layanan') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <textarea id="layanan" name="layanan" class="form-control">{{$settings['layanan'] ?? null}}</textarea>
                            <div class="d-flex justify-content-end mt-2">
                                <button type="submit" class="btn btn-dark">Save</button>
                            </div>
                       </form>
                    ...
                    <div class="tab-pane fade" id="v-kerja-sama" role="tabpanel" aria-labelledby="v-kerja-sama-tab">
                       <form action="{{ route('admin.setting.kerja-sama') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <textarea id="kerja_sama" name="kerja_sama" class="form-control">{{$settings['kerja_sama'] ?? null}}</textarea>
                            <div class="d-flex justify-content-end mt-2">
                                <button type="submit" class="btn btn-dark">Save</button>
                            </div>
                       </form>
    ...
    @push('js')
        <script>
            $(document).ready(function() {
                ...
                tinymce.init({
                    selector: "textarea#tentang_kami",
                    height: 300,
                    plugins: [
                        "advlist autolink link image lists charmap print preview hr anchor pagebreak spellchecker table",
                    ],
                ...
                tinymce.init({
                    selector: "textarea#syarat_ketentuan",
                    height: 300,
                    plugins: [
                        "advlist autolink link image lists charmap print preview hr anchor pagebreak spellchecker table",
                    ],
