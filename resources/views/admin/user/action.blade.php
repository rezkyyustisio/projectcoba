...
<button type="button" class="btn btn-dark waves-effect btn-label waves-light delete-item" data-tableid="table" data-action="Delete" data-url="{{ route('admin.user.destroy', $id) }}"><i class="bx bx-trash label-icon"></i> Delete</button>
